...
public class PickMeetingController extends PadreController {
    ...
    public void Inicializador() {
        ...
        cboxSeleccionReunion.getItems().addAll(createCollection());
    ...
    private ArrayList<Reunion> createCollection(){
        ...
        reuniones.add(new Reunion(1, "42", "Titulo 1", "20-10-2021 12:04:20", "20-10-2021 01:04:20", "234-756-234", participantes));
        reuniones.add(new Reunion(2, "52", "Titulo 2", "21-10-2021 12:04:20", "21-10-2021 01:04:20", "123-234-234", participantes));
        reuniones.add(new Reunion(3, "32", "Titulo 3", "22-10-2021 12:04:20", "22-10-2021 01:04:20", "432-234-432", participantes));
        reuniones.add(new Reunion(4, "62", "Titulo 4", "23-10-2021 12:04:20", "23-10-2021 01:04:20", "123-754-453", participantes));
